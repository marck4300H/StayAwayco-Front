...
const secciones = [
  {
    ...
    contenido: `Al acceder, navegar o realizar cualquier compra a través de la plataforma StayAway, el usuario —en adelante "Participante"— declara haber leído, comprendido y aceptado en su totalidad los presentes Términos y Condiciones, así como la Política de Privacidad vigente.
...
StayAway se reserva el derecho de modificar unilateralmente estos Términos y Condiciones en cualquier momento y sin previo aviso, mediante la actualización del presente documento. El uso continuado de la plataforma después de cualquier modificación constituye la aceptación de dichos cambios.`,
  },
  {
    id: "autorizacion",
    icono: "⚖️",
    titulo: "2. Autorización Legal de las Actividades",
    contenido: `Todas las actividades y sorteos realizados a través de StayAway cuentan con la debida autorización de las entidades competentes. Dicha autorización puede ser otorgada por:
...
Los números de resolución, fechas de autorización y entidad autorizante de cada actividad son publicados en la plataforma y en nuestras redes sociales oficiales. El Participante puede verificar en cualquier momento la legitimidad de cada sorteo a través de dichos medios.

StayAway garantiza que ninguna actividad se realiza sin contar previamente con la autorización legal correspondiente de la entidad reguladora aplicable según la normativa colombiana vigente.`,
  },
  {
    id: "participacion",
    icono: "🎟️",
    titulo: "3. Participación y Elegibilidad",
    contenido: `Para participar en cualquier actividad organizada por StayAway se requiere:
...
StayAway NO instiga, promueve ni invita a menores de edad a participar en ninguna actividad. Tampoco fomenta conductas de juego compulsivo o adictivo. Los sorteos son juegos de azar y, por su naturaleza, no garantizan que todos los participantes obtengan un premio. Participar implica aceptar libremente este riesgo.
...
El premio será entregado exclusivamente a la persona cuyo documento de identidad haya sido registrado al momento de la compra de la calca ganadora. Esta es la única forma válida de acreditar la titularidad del premio.

4.2 Reclamación por terceros
En caso de que el ganador no pueda reclamar personalmente su premio, podrá autorizar a un tercero mediante documento escrito debidamente firmado por el titular del documento registrado, acompañado de copia de su documento de identidad. Sin este requisito, StayAway no está obligado a entregar el premio a ninguna persona diferente al titular.

4.3 Plazo de entrega
Los premios serán entregados dentro de los cinco (5) días hábiles siguientes a la fecha y hora de publicación oficial del resultado de la lotería de referencia. Pasado este plazo sin que el ganador se haya comunicado, StayAway realizará el contacto a través de los datos registrados en la plataforma.
...
Cuando entre los premios se ofrezca un pase o licencia de conducción, este beneficio aplica únicamente si el titular del documento ganador NO posee dicho documento al momento de reclamar el premio. StayAway no está obligado a otorgar este premio ni a brindar compensación económica equivalente si el ganador ya cuenta con el pase o licencia vigente, salvo que expresamente se haya comunicado lo contrario en nuestras redes sociales o en la promoción correspondiente.`,
  },
  {
    ...
    contenido: `Las promociones, descuentos y beneficios adicionales ofrecidos por StayAway son habilitados según criterio propio y comunicados a través de nuestras redes sociales oficiales y/o en la plataforma.

StayAway se reserva el derecho de:
...
• Limitar la aplicación de promociones a determinados usuarios, actividades o períodos de tiempo.

Las promociones publicadas en canales no oficiales de StayAway no tienen validez. El Participante debe verificar siempre la autenticidad de cualquier oferta a través de nuestros canales oficiales.`,
  },
  {
    id: "soporte",
    icono: "🛠️",
    titulo: "6. Soporte y Resolución de Inconvenientes",
    contenido: `Cualquier inconveniente, reclamación o solicitud presentada al equipo de soporte de StayAway será atendida en un plazo máximo de treinta (30) días hábiles contados desde la fecha de radicación formal de la solicitud.
...
• La decisión adoptada por StayAway dentro del plazo establecido será comunicada a través del correo electrónico registrado.

Para presentar una solicitud de soporte, el Participante debe utilizar exclusivamente los canales oficiales habilitados por StayAway. Solicitudes realizadas por medios no oficiales no generan obligación de respuesta dentro del plazo señalado.`,
  },
  {
    id: "privacidad",
    icono: "🔒",
    titulo: "7. Política de Privacidad y Tratamiento de Datos",
    contenido: `De conformidad con la Ley 1581 de 2012 y el artículo 15 de la Constitución Política de Colombia, StayAway adopta las siguientes políticas de tratamiento de datos personales:
...
StayAway no venderá, alquilará ni cederá los datos personales del Participante a terceros sin su consentimiento expreso, salvo requerimiento de autoridad competente.
...
El Participante podrá ejercer en cualquier momento sus derechos de acceso, corrección, supresión y portabilidad de sus datos personales a través de los canales de soporte oficiales de la plataforma.`,
  },
  {
    ...
    contenido: `StayAway es titular de todos los derechos de propiedad intelectual e industrial sobre la plataforma, incluyendo sin limitarse a: diseño gráfico, logotipos, textos, imágenes, software y bases de datos.

Queda expresamente prohibido:

• Reproducir, distribuir o modificar cualquier contenido de la plataforma sin autorización escrita previa.
• Usar el nombre, logotipo o identidad visual de StayAway para fines comerciales sin autorización.
...
El incumplimiento de cualquiera de estas prohibiciones faculta a StayAway para suspender o cancelar definitivamente la cuenta del usuario sin derecho a reembolso, y a ejercer las acciones legales correspondientes.`,
  },
  {
    id: "jurisdiccion",
    icono: "🏛️",
...
Cualquier controversia derivada de la interpretación o aplicación de estos términos será resuelta por los jueces competentes de la República de Colombia, con domicilio principal en la ciudad donde opere StayAway.
    ...
    <div className="terminos-container">
      ...
      <div className="terminos-hero">
        <div className="terminos-hero-inner">
          ...
          <p className="terminos-hero-subtitulo">
            StayAway — Plataforma de actividades autorizadas en Colombia
          </p>
      ...
      <div className="terminos-aviso">
        <div className="terminos-aviso-inner">
          ...
          <p>
            Al participar en cualquier actividad de StayAway, el usuario declara ser{" "}
